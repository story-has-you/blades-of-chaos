...
public class IdcardUtils {
    ...
    public static boolean isValidCard18(String idCard) {
        ...
        //校验生日
        if (!RegexUtils.checkBirthday(idCard.substring(6, 14))) {
            return false;
        }
        ...
        if (RegexUtils.checkDigit(code17)) {
            // 获取校验位
    ...
    public static boolean isValidCard15(String idCard) {
        ...
        if (RegexUtils.checkDigit(idCard)) {
            ...
            //校验生日（两位年份，补充为19XX）
            return RegexUtils.checkBirthday("19" + idCard.substring(6, 12));
        } else {
            return false;
        }
    }
    ...
    public static LocalDate getBirthDate(String idCard) {
        ...
        return null == birthByIdCard ? null : LocalDate.parse(birthByIdCard, DatePattern.PURE_DATE_FORMAT);
    }
    ...
    private static char getCheckCode18(int iSum) {
        switch (iSum % 11) {
            ...
            case 0:
                return '1';
            default:
                return StringPool.SPACE.charAt(0);
        }
    }
